<template>
  <div class="relative mb-6 animate-fade-in">
    <div class="rounded-2xl p-6 text-white md:flex md:items-center md:justify-between schoolcard-div">
      <div class="md:flex-1">
    ...
    <div v-if="showSchoolDropdown" class="w-full overflow-hidden rounded-b-2xl shadow-lg border-t-0 schoolcard-dropdown">
      <div class="p-4">
